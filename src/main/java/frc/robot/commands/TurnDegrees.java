...
public class TurnDegrees extends CommandBase {
  ...
  @Override
  public void execute() {
    m_drive.arcadeDrive(0, m_speed - ((m_speed - TurnConstants.speedDecrement * (Math.pow(Math.abs(m_drive.getGyroAngleZ()) / 90, 2.0))) * (m_speed - 0.1)));
    System.out.println("Speed: " + (m_speed - ((m_speed - TurnConstants.speedDecrement * (Math.pow(Math.abs(m_drive.getGyroAngleZ()) / 90, 2.0))) * (m_speed - 0.1))));
  }
